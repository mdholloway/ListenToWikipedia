...
hammerHardness = hslider("hammerHardness",0.85,0,1,0.01) : ba.sAndH(gate);
hammerSize = hslider("hammerSize",0.5,0,1,0.01) : ba.sAndH(gate);
...
process = hammer(gate,hammerHardness,hammerSize) : modalModel(exPos,30,1,2.5)*gain <: _,_;
